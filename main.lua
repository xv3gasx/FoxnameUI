...
local function CreateElements(theme, colorpickerRegistry)
    ...
    function Elements:Keybind(parent, cfg)
        ...
        local btn = mk("TextButton", {
            Parent = parent, Size = UDim2.new(1, 0, 0, 42), BackgroundColor3 = theme.Surface2,
            BorderSizePixel = 0, Text = "", AutoButtonColor = false,
        })
        mk("UICorner", {Parent = btn, CornerRadius = UDim.new(0, 10)})
...
function FoxnameUI:CreateWindow(cfg)
    ...
    local searchBox = mk("TextBox", {
        Parent = tabButtons, Size = UDim2.new(1, 0, 0, 32), BackgroundColor3 = CurrentTheme.Surface2, BorderSizePixel = 0,
    ...
    local contentArea = mk("Frame", {
        Parent = main, Position = UDim2.new(0, 164, 0, 58), Size = UDim2.new(1, -164, 1, -58), BackgroundTransparency = 1,
    })
    ...
    local function createNavSection(cfg)
        ...
        local opened = cfg.Opened ~= false
        local row = mk("Frame", {
            Parent = tabButtons, Size = UDim2.new(1, 0, 0, opened and 78 or 36),
            BackgroundTransparency = 1, BorderSizePixel = 0, ClipsDescendants = true,
        })
        local head = mk("TextButton", {
            Parent = row, Size = UDim2.new(1, 0, 0, 36), BackgroundColor3 = CurrentTheme.Surface2,
            BorderSizePixel = 0, Text = "", AutoButtonColor = false,
        })
    ...
    local function createTab(parentContainer, nameOrCfg, iconArg, secRef)
        ...
        local btn = mk("TextButton", {
            Parent = parentContainer, Size = UDim2.new(1, 0, 0, 38), BackgroundColor3 = CurrentTheme.Surface2,
